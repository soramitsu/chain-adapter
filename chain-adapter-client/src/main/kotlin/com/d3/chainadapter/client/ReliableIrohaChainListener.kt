...
open class ReliableIrohaChainListener @JvmOverloads constructor(
     ...
     */
    fun getBlockObservable(): Result<Observable<Pair<BlockOuterClass.Block, () -> Unit>>, Exception> =
        Result.of { sharedSource }
    ...
    fun listen(): Result<Unit, Exception> {
        return Result.of {
            ...
            val deliverCallback = { _: String, delivery: Delivery ->
                ...
                val block = BlockOuterClass.Block.parseFrom(delivery.body)
     ...
     */
    fun getBlock(): Pair<BlockOuterClass.Block, () -> Unit> {
        ...
        val block = BlockOuterClass.Block.parseFrom(resp.body)
        return Pair(block, {
            if (!autoAck)
     ...
     */
    private fun confirmDelivery(deliveryTag: Long, block: BlockOuterClass.Block) {
